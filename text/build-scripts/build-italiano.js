...
// the resulting translation saved as `translation.txt` in the `italiano` folder.
//
...
import { quotedHint } from "./build-translation-template";
...
const folder = path.join(__dirname, "../", "languages", "italiano");
